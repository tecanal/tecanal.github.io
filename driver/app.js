...
app.config(["$routeProvider", "$locationProvider", function($routeProvider, $locationProvider) {
    ...
    $routeProvider
        .when("/", {
            title: "TeCanal Driver Portal",
            templateUrl: "templates/home.html",
            controller: 'HomeCtrl'
        })
        .when("/admin", {
            title: "Driver Portal Admin Panel",
            templateUrl: "templates/admin.html",
            controller: 'AdminCtrl'
        })
        .when("/driver-reimbursement", {
            title: "Driver Reimbursement",
            templateUrl: "templates/driver-reimbursement.html"
        })
        .when("/support-material", {
            title: "Support Material",
            templateUrl: "templates/support-material.html"
        })
